...
permalink: environment--hotms-s-icn-local
nav_exclude: true
---
...
The Identity Controlled Network subsystem is physically laid out on a hybrid cloud infrastructure.
