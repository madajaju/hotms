...
permalink: environment--hotms-s-mtd-local
nav_exclude: true
---
...
The Man Trap Deployment subsystem is physically laid out on a hybrid cloud infrastructure.
