...
permalink: environment--hotms-s-ddc-local
nav_exclude: true
---
...
The Data Diode Communication subsystem is physically laid out on a hybrid cloud infrastructure.
